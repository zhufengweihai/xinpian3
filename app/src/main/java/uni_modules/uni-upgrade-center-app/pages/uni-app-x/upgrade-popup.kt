...
open class GenUniModulesUniUpgradeCenterAppPagesUniAppXUpgradePopup : BasePage {
            ...
            createElementVNode("view", utsMapOf("class" to "content"), utsArrayOf(
                ...
                createElementVNode("view", utsMapOf("class" to "content-body"), utsArrayOf(
                    ...
                    createElementVNode("view", utsMapOf("class" to "footer flex-center"), utsArrayOf(
                        if (isTrue(_ctx.isiOS || _ctx.isHarmony)) {
                            createElementVNode("button", utsMapOf("key" to 0, "class" to "content-button", "style" to normalizeStyle(utsMapOf("border" to "none", "color" to "#fff")), "type" to "primary", "plain" to "", "onClick" to _ctx.jumpToAppStore), toDisplayString(_ctx.downLoadBtnTextiOS), 13, utsArrayOf(
                                "onClick"
                            ))
                        } else {
    ...
    open var isHarmony: Boolean by `$data`
    ...
    override fun data(): Map<String, Any?> {
        ...
        ), "isHarmony" to computed<Boolean>(fun(): Boolean {
            return this.platform.includes(platform_Harmony)
        }
    ...
    open var downloadFail = ::gen_downloadFail_fn
    open fun gen_downloadFail_fn() {
