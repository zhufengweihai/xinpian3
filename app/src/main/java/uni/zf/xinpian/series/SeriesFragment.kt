...
class SeriesFragment : Fragment(), SearchParamListener {
    ...
    private fun setupGenreView() {
        ...
        binding.genreView.apply {
            ...
            adapter = SearchParamAdapter(category, GENRES, 0, this@SeriesFragment)
        }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(category: String?): SeriesFragment {
            return SeriesFragment().apply {
