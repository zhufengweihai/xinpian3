...
object AppConst {
    ...
    val filterOptionsUrl = "https://${jpUrlPrefix}.zxfmj.com/api/crumb/filterOptions?fcate_pid="
    val filteredVideoUrl = "https://${jpUrlPrefix}.zxfmj.com/api/crumb/list?fcate_pid=&category_id=&area=&year=&type=&sort=&page=%d"
}
